export function textInnerBlock(
  color,
  heading,
  content,
  bodyColor = "#111",
...
export function mColTextInnerBlock(color, heading, column, object) {
  return `
<tr>
...
export function textBlockTable(
  color,
  heading,
  content,
  bodyColor,
...
export function mColTextBlockTable(color, heading, column, object) {
  return `
<table align="center" border="0" cellpadding="0" cellspacing="0"
...
export function textHeading(color, heading, status, statusColor) {
  return `
<h2>
  <span
...
export function textHeadingH4(color, heading, img, statusColor, segment, url) {
  return `
...
export function checkForUrlAndAttachVisitSite(url, heading, img) {
  if (url && url !== null) {
...
export function textWithHeadingRow(
  color,
  heading,
  content,
  bodyColor,
...
export function mColTextWithHeading(color, object) {
  return `
...
export function mColTextRow(color, column, object) {
  return `<tr>
<td valign="top" class="mcnTextBlockInner">
<table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
  <tbody>
...
export function test(color, bodyColor, Heading) {
  return `<tr>
...
export function PillarsSegments(
  image,
  heading,
  description,
  padding,
...
export function textAndImageSideBySide(
  heading,
  desc,
  statusColor,
  url,
