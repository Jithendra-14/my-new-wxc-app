...
const url_prefix =
  "https://wxci.azurewebsites.net/web/de/newsletter/Monthly/Nov23/";
const image_prefix = "/api/web/de/newsletter/Monthly/Nov23/";
const defaultColor = {
  headingColor: "#000",
  bgColor: "#fff",
  color: "#4D4D4D",
...
const banner = {
  ...
  path: image_prefix + "tmp/images/NovHeader.png",
...
const health_image = {
  type: layoutType.imageBanner,
  path: image_prefix + "tmp/images/HealthExpertPlatform.gif",
  alt: "Gif Onboarding Health Experts",
  width: 820,
  padding: "0px 40px;",
  background: bing.bgColor,
  url:
    "https://www.msn.com/en-in/health/expert-profile/start-health-creator/hp-myprofile",
};
...
const travel_image = {
  type: layoutType.imageBanner,
  path: image_prefix + "tmp/images/travel-destination-overlay.gif",
  alt: "Bing Travel Destination Overlay Image",
  width: 820,
  padding: "0px 40px;",
  background: bing.bgColor,
  url:
    "https://www.bing.com/travel/place-information?q=paris+france&SID=85584d24-2116-5b98-89f9-5714db931ac6&itemId=YN2000x18174703802019270958&scenario=SeeAndDo&form=PLACAB&entrypoint=PLACAB&cc=us&setlang=en",
};
...
const travel_image1 = {
  type: layoutType.imageBanner,
  path: image_prefix + "tmp/images/travel-assistant-1.gif",
  alt: "Bing Travel Assistant Page",
  width: 820,
  padding: "0px 40px;",
  background: bing.bgColor,
  url:
    "https://www.bing.com/travel/hotel-search?q=hotels+in+new+york%2C+united+states&cin=2023-11-15&cout=2023-11-16&guests=2A0C&age=&rooms=1&displaytext=New+York%2C+United+States&loc=New+York%2C+United+States&lat=40.71455001831055&lon=-74.00711822509766&form=HOTHTL&entrypoint=UNKHUB&sf=trvlrrcmp&cc=us&setlang=en",
};
...
const travel_image2 = {
  type: layoutType.imageBanner,
  path: image_prefix + "tmp/images/city-go-big-seeando.png",
...
const relevance_image = {
  type: layoutType.imageBanner,
  path: image_prefix + "tmp/images/chat-coherence.png",
  alt: "SERP page with chat coherence changes",
  width: 820,
  padding: "0px 40px;",
  background: bing.bgColor,
  url:
    "https://www.bing.com/search?q=mexico+news&form=QBLH&sp=-1&ghc=1&lq=0&pq=mexico+new&sc=6-10&qs=n&sk=&cvid=8F0BCE8D3F6F44D18F3CBCC57BEE2559&ghsh=0&ghacc=0&ghpl=&setflight=paasepaftrqt&cc=us&setlang=en",
};
...
const relevance_image2 = {
  type: layoutType.imageBanner,
  path: image_prefix + "tmp/images/waterfall.png",
  alt: "Bing Waterfall PAA Page",
  width: 820,
  padding: "0px 40px;",
  background: bing.bgColor,
  url:
    "https://www.bing.com/search?q=figma&FORM=AWRE&setmkt=en-US&setflight=enblmlwtrflt&cc=us&setlang=en",
};
...
const sports_image1 = {
  ...
  image1: {
    path: image_prefix + "tmp/images/f1-gif 1.gif",
    alt: "F1 search image",
    width: 460,
    padding: "0 0 0 0;",
  },
  image2: {
    path: image_prefix + "tmp/images/mob-f1-gif.gif",
    alt: "F1 search image",
    width: 220,
    padding: "0 0 6px 0;",
  },
  ...
  url:
    "https://www.bing.com/search?q=f1&qs=n&features=sportsarena,sportsarenaall,sportsarenaind",
};
...
const sports_image2 = {
  ...
  background: edge.bgColor,
  image1: {
    path: image_prefix + "tmp/images/dF1-gif.gif",
    alt: "Driver f1 search image",
    width: 460,
    padding: "0 0 0 0;",
  },
  image2: {
    path: image_prefix + "tmp/images/mob-d-gif.gif",
    alt: "Driver f1 search image",
    width: 220,
    padding: "0 0 6px 0;",
  },
  ...
  url:
    "https://www.bing.com/search?q=Max+Verstappen&go=Search&qs=ds&form=QBRE&features=sportsarena,sportsarenaall,sportsarenaind",
};
...
const edge_image = {
  type: layoutType.imageBanner,
  path: image_prefix + "tmp/images/phoenix.gif",
...
nGenJSON = [
  ...
  {
    type: layoutType.imageBanner,
    path: image_prefix + "tmp/images/NovFooter.png",
    alt: "footer",
    width: 900,
